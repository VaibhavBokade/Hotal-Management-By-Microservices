package com.hotel.HotelService.service.serviceImpl;
...
public class HotelServiceImpl implements HotelService {
    ...
    public Hotel getHotel(String id) {
        return hotelRepository.findById(id).orElseThrow(()-> new ResourceNotFoundException("Hotel with "+id+ " is not found !"));
    }
}
